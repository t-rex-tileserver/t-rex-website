...
```
curl -O -L https://github.com/t-rex-tileserver/t-rex/releases/download/v0.9.3/t-rex-v0.9.3-x86_64-unknown-linux-gnu.deb && sudo dpkg -i t-rex-v0.9.3-x86_64-unknown-linux-gnu.deb
```
...
[t-rex-v0.9.3.msi](https://github.com/t-rex-tileserver/t-rex/releases/download/v0.9.3/t-rex-v0.9.3.msi)
